                ...
                <div class="col-sm-9 col-md-7 col-lg-10 mx-auto">
                    <div class="card border-0 shadow rounded-3 my-5">
                        <div class="card-body p-4 p-sm-5">
                            ...
                            <form class="mt-4 row g-3 " action="aksi.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-3">
                                    <input class="form-control me-3" type="file" id="formFile" name="pict1">
  ...
  <span class="text-danger" id="spec_error"></span>
    ...
    <script>
        document.querySelector('form').addEventListener('submit', function (event) {
            const requiredFields = ["category", "pict", "nama", "desk", "spec", "harga"];
